...
https://www.javatpoint.com/contentpane-java (For contentPane understandings)

https://javarevisited.blogspot.com/2017/04/difference-between-repaint-and-revalidate-in-Swing-Java.html#google_vignette (For understanding revalidate. Needed revalidate to go between pages from home screen)

https://www.youtube.com/watch?v=gm8ZWF2hLPY (revalidate contents)

https://www.youtube.com/watch?v=rioHqpj5xWo (revalidate contents) 

https://codegym.cc/groups/posts/bufferedreader-and-bufferedwriter (Contents regarding BufferedWriter and BufferedReader for better understanding and implementing systems such as saving leaderboards, coins, skins, and other player datasets)

https://www.youtube.com/watch?v=DmMnfP2hYEo (BufferedReader and BufferedWriter)

https://owlcation.com/stem/Java-BufferedReader-and-BufferedWriter-Example (BufferedReader and Buffered Writer)

https://www.quora.com/What-is-readLine-in-Java (for reading from console)

https://www.w3schools.com/java/ref_string_startswith.asp (startswith)

https://www.w3schools.com/java/ref_string_substring.asp (substring)

https://www.w3schools.com/java/ref_string_split.asp(split)

https://www.tutorialspoint.com/java/java_files_io.htm (filo i/o)
